...
Yazin: Sure. So we run four personas in round-robin — Not Jamie the fact checker, Not Delinquent the conspiracy guy, Not Taco the chihuahua comedian, and Not Fred the sound-effects producer. They each get about 800 milliseconds of latency end-to-end from when you finish a sentence.
